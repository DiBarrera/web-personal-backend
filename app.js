...
mongoose
  .connect('mongodb+srv://diegobarrera:Holamundo2021@cluster0.ubmvm.mongodb.net/webpersonal', {useNewUrlParser: true})   // <=== ESTO ES NUEVO
  .then(x => {
...
// Load routings                            // <=== ESTO ES NUEVO
const userRoutes = require('./routes/user');

// Router Basic                             // <=== ESTO ES NUEVO
app.use(`/`, userRoutes);
